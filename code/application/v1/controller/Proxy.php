...
class Proxy extends Controller
{
    ...
    protected function _initialize()
    {
        ...
        $center = \app\v1\model\MoocCenter::get(1);
        cookie(self::ADMIN_TOKEN, $center['center_token'], 86400);
        cookie(self::ADMIN_SALT,  $center['salt'], 86400);
    }
    ...
    {
        $payload = ['timestamp' => time()];
        $payload['center_user_id'] = $this->_get_uid();
        $payload['center_id'] = config('proxy.center_id');
