var sourceFeature3 = new ol.source.Vector({
    wrapX: false
});
var layerFeature3 = new ol.layer.Vector({
    source: sourceFeature3,
    minResolution: epsg_4326[9],
    maxResolution: epsg_4326[8] //9级显示，不含8
});
                ...
                for (var i = 0; i < result.length; i++) {
                   ...
                   // console.log(filterType);
                    if (result[i].site_level <= 3 ) {
                        ...
                        sourceFeature3.addFeature(feature);
                    }
