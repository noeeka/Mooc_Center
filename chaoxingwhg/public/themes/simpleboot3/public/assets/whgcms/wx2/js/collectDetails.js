        ...
        success: function (res) {
            if (res.status == 1) {
                ...
                if (res.data.is_collect == 1) {
                    // console.log
                    $('.collectBtn img').attr('src', '/themes/simpleboot3/public/assets/whgcms/wx/images/dianzan2.png');
                }
            ...
            success: function (res) {
                if (res.status == 1) {
                    ...
                    if (res.code == 13102) {
                        ...
                        // 取消收藏
                        $('.collectBtn img').attr('src', '/themes/simpleboot3/public/assets/whgcms/wx/images/dianzan1.png');
                        if (collect_num > 0) {
                            collect_num--;
                            $('.collectBtn span').text(collect_num);
                        }
        ...
        return $('.test1').dropload({
            ...
            loadDownFn: function (me) {
                request({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {zuopin_id: article_id, page: page, len: comment_limit},
                    success: function (res) {
                        if (res.status == 1) {
                            page++;
