$(function() {
    ...
    requestCollect(1, function(res) {
        if (res.status == 1) {
            ...
            if (res.data.count == 0) {
                $('#collect_page .layui-laypage-next').hide();
            }
        }
    })
    ...
    function initSysMessage() {
        requestSysMessage(1, function(res) {
            if (res.status == 1) {
                ...
                if (res.data.count == 0) {
                    $('#message_page .layui-laypage-next').hide();
                }
            }
        })
    }
        ...
        request({
            ...
            success: function(response) {
                if (response.status == 1) {
                    ...
                    if (response.data.count == 0) {
                        $('#huodong .layui-laypage-next').hide();
                    }
...
$('#contactsave').click(function(event) {
    /* Act on the event */
    $('#contact').hide();
    $('#authentication').show();
});