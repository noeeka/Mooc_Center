            ...
            if (res.status == 1) {
                ...
                Handlebars.registerHelper('image', function(value) {
                    if (value == '') {
                        ...
                        return value + "?width=790";
                    }
                });
                Handlebars.registerHelper('is_collect', function(value) {
                    return value == 0 ? 'like1.png' : 'like2.png';
                });
                for (x in res.data['categorys']){
                    res.data['categorys'][x]['url'] = '/portal/articles/'+res.data['top_cid']+'?active_id='+res.data['categorys'][x]['id'];
                }
