$(function(){
    ...
    function bannerSwiper(){
        ...
        // $('.swiper-slide').css({ 'width': width80 + 'px' });
        $('.swiper-slide').css({ 'width': slideWidth + 'px' });
        // $('.swiper-slide-active').css({ 'width': width80 + 'px' });
    ...
    $.ajax({
        type:'get',
        url:'/api/article/index?cid=167&len=2',
        ...
        success: function(res) {
            if(res.status == 1){
                ...
                for(var i = 0; i< bannerData.length;i++){
                    ...
                    }else if(bannerData[i].murl.indexOf(host)!=-1){
                        bannerData[i].murl = bannerData[i].murl;
                    }else{
