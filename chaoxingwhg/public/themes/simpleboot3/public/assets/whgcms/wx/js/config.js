...
(function(w) {
    ...
    C.interface = {
        ...
        news: 'article/news',
            ...
            //读取实名认证信息
            auth_read: 'user/auth_read',
            //提交实名认证信息
            authReal_user: 'user/auth_real_user',
            //修改密码
            changePassword: 'user/savepassword',
            //意见反馈
            ...
            //收藏列表
            collectList: 'collect/index',
            //点击收藏
            artCollect: 'article/collect',
            //节目点单列表
            diandanList: 'diandan/index',
            //节目点单详情
            diandanRead: 'diandan/read',
            //节目点单
            diandan: 'diandan/diandan',
