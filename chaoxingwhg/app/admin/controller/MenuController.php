...
class MenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $result     = Db::name('AdminMenu')->where('rule_show' , 1)->order(["list_order" => "ASC"])->select()->toArray();
        $tree       = new Tree();
        $tree->icon = ['&nbsp;&nbsp;&nbsp;│ ', '&nbsp;&nbsp;&nbsp;├─ ', '&nbsp;&nbsp;&nbsp;└─ '];
        $tree->nbsp = '&nbsp;&nbsp;&nbsp;';
    ...
    public function lists()
    {
        ...
        $result = Db::name('AdminMenu')->where('rule_show' , 1)->order(["app" => "ASC", "controller" => "ASC", "action" => "ASC"])->select();
    ...
    public function add()
    {
        ...
        $result   = Db::name('AdminMenu')->where('rule_show' , 1)->order(["list_order" => "ASC"])->select();
        $array    = [];
        foreach ($result as $r) {
