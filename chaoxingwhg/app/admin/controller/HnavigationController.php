...
class HnavigationController extends AdminBaseController
{
    /*
     * 公共文化活动资源库
     * */
    public function index()
    {
        ...
        $navigationTree = $navModel->adminNavigationTableTree(0,'',6);
    ...
    public function add()
    {
        ...
        $nav_tree = $navigationModel->adminNavigationTree($id,0,0,[],6);
    ...
    public function addPost(){
        if($this->request->isPost()){
            ...
            $this->success('添加成功',url('Hnavigation/index'));
        }
    }
    /**
     * 首页导航编辑
    ...
    public function editPost()
    {
        if($this->request->isPost()){
            ...
            $this->success('保存成功!','Hnavigation/index');
        }
    }
    /**
     * 首页导航排序
