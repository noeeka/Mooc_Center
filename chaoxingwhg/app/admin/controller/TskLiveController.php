...
class TskLiveController extends AdminBaseController
{
    /*
     * 直播列表
     */
    ...
    public function addPost()
    {
        ...
        $data['type'] =1;
        $result = $liveBroadcast->validate(true)->allowField(true)->save($data);
        if ($result) {
            $this->success('添加直播成功', 'TskLive/index');
        } else {
    ...
    public function editPost()
    {
        ...
        if ($result) {
            $this->success("修改成功！", url("TskLive/index"));
        } else {
    ...
    public function delete()
    {
        ...
        $this->success("删除成功！", url("TskLive/index"));
    }
