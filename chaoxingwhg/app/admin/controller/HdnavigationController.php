...
class HdnavigationController extends AdminBaseController
{
    /*
     * 互动体验资源库
     * */
    public function index()
    {
        ...
        $navigationTree = $navModel->adminNavigationTableTree(0,'',5);
    ...
    public function add()
    {
        ...
        $nav_tree = $navigationModel->adminNavigationTree($id,0,0,[],5);
    ...
    public function addPost(){
        if($this->request->isPost()){
            ...
            $this->success('添加成功',url('Hdnavigation/index'));
        }
    }
    /**
     * 首页导航编辑
    ...
    public function editPost()
    {
        if($this->request->isPost()){
            ...
            $this->success('保存成功!','Hdnavigation/index');
        }
    }
    /**
     * 首页导航排序
