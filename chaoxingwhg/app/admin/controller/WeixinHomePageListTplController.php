...
class WeixinHomePageListTplController  extends AdminBaseController
{
    //显示微信模板列表
    public function index()
    {
        $homePageModel = new HomePageTplModel();
        $homePageList = $homePageModel->where(['type'=>1])->paginate(10);
    ...
    public function addPost()
    {
        ...
        if($result === false){
            ...
            $this->success("添加成功",'weixin_home_page_list_tpl/index');
        }
    ...
    public function editPost()
    {
        ...
        if($result === false){
            ...
            $this->addLog($data,0);
            $this->success('保存成功','weixin_home_page_list_tpl/index');
        }
    ...
    public function delete()
    {
        ...
        $this->success("删除成功！", url("weixin_home_page_list_tpl/index"));
    }
