...
class WnavigationController extends AdminBaseController
{
    /*
     * 文化场馆资源库
     * */
    public function index()
    {
        ...
        $navigationTree = $navModel->adminNavigationTableTree(0,'',7);
    ...
    public function add()
    {
        ...
        $nav_tree = $navigationModel->adminNavigationTree($id,0,0,[],7);
    ...
    public function addPost(){
        if($this->request->isPost()){
            ...
            $this->success('添加成功',url('Wnavigation/index'));
        }
    }
    /**
     * 首页导航编辑
    ...
    public function editPost()
    {
        if($this->request->isPost()){
            ...
            $this->success('保存成功!','Wnavigation/index');
        }
    }
    /**
     * 首页导航排序
