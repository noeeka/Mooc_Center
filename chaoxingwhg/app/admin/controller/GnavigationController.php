...
class GnavigationController extends AdminBaseController
{
    /*
     * 公共文化共享资源库
     * */
    public function index()
    {
        ...
        $navigationTree = $navModel->adminNavigationTableTree(0,'',4);
    ...
    public function add()
    {
        ...
        $nav_tree = $navigationModel->adminNavigationTree($id,0,0,[],4);
    ...
    public function addPost(){
        if($this->request->isPost()){
            ...
            $this->success('添加成功',url('Gnavigation/index'));
        }
    }
    /**
     * 首页导航编辑
    ...
    public function editPost()
    {
        if($this->request->isPost()){
            ...
            $this->success('保存成功!','Gnavigation/index');
        }
    }
    /**
     * 首页导航排序
