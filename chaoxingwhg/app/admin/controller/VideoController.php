...
class VideoController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $data = $postService->adminArticleList($param, $haveChild , 1);
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $cid = $data['cid'];
            unset($data['cid']);
            $post['post_excerpt'] = '精彩视频';
            $post['post_content'] = '精彩视频';
            ...
            $this->success('添加成功!', url('Video/edit', ['id' => $portalPostModel->id ,'cid' => $cid ]));
        }
