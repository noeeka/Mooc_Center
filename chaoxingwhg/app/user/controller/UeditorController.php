...
//                        "task" => "storeFile"
//                    ]);
                    $return = $weed->storeFile($fileKey,$filePath);
                    $result['weedPath'] = $weed->weedVolume. DIRECTORY_SEPARATOR. $fileKey.'.jpg?width=740';
            ...
            return json_encode([
                'state'    => 'SUCCESS',
                'url'      => $weed->weedVolume. DIRECTORY_SEPARATOR. $result['file_store_key'].'.jpg?width=760',
                'title'    => $result['name'],
                'original' => $result['name'],
//                'url'      => $result['url'],
                'weedPath' => $weed->weedVolume. DIRECTORY_SEPARATOR. $result['file_store_key'].'.jpg?width=740',
            ]);
        } else {
            return json_encode([
                'state'    => 'SUCCESS',
